...
ARG NEXT_PUBLIC_PORT_RANGE_START
ENV NEXT_PUBLIC_PORT_RANGE_START=$NEXT_PUBLIC_PORT_RANGE_START

ARG NEXT_PUBLIC_PORT_RANGE_END
ENV NEXT_PUBLIC_PORT_RANGE_END=$NEXT_PUBLIC_PORT_RANGE_END
